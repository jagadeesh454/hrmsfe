...
function AddEmployee() {
  ...
  const handleSubmit = () => {
    const { employeeId, name, department, email, designation, date, type } = employeeData
    if (employeeId && name && department && email && designation && date && type) {
  ...
  useEffect(() => {
    if (submit) {
      fetch("http://localhost:3001/api/v1/employees", {
        ...
        .then(data => alert("employee created"))
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form>
                ...
                <div className='mb-2' style={{ height: " 100%", width: "100%" }}>
                  <select name="type" id="type" className='form-control' placeholder="Employee Type" onChange={(e) => changeHandler(e)}>
                ...
                <div className="mb-2">
                  <input type="text" className="form-control" placeholder='Name' name='name' onChange={(e) => changeHandler(e)} />
                </div>
                <div className="mb-2">
                  <input type="email" className="form-control" placeholder='Email' name="email" onChange={(e) => changeHandler(e)} />
                </div>
                ...
                <div className="mb-2">
                  <input type="date" className="form-control" placeholder='Joining Date' name="date" onChange={(e) => changeHandler(e)} />
                </div>
              </form>
            </div>
